...
SVGElement.prototype.set = function (attributeName, value) {
  this.element.setAttribute(attributeName, value);
};

SVGElement.prototype.style = function (property, value) {
...
function animateLetterIn(letter) {
...
function addDecor(letter, color) {
  setTimeout(() => {
